    ...
    private void handleUploadFile(ActionEvent event) {
        try (InputStream inputStream = new FileInputStream(selectedFile);
            ...
            for (Row row : sheet) {
                ...
                form.put("num",row.getCell(0).toString());
                form.put("name",row.getCell(1).toString());
                form.put("dept",row.getCell(2).toString());
                form.put("major",row.getCell(3).toString());
                form.put("className",row.getCell(4).toString());
                form.put("card",row.getCell(5).toString());
                form.put("gender",row.getCell(6).toString());
                form.put("birthday",row.getCell(7).toString());
                form.put("email",row.getCell(8).toString());
                form.put("phone",row.getCell(9).toString());
                form.put("address",row.getCell(10).toString());
                //System.out.println(form);
