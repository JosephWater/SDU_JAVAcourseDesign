...
public class DailyActivitiesController extends ToolController {
    @FXML
    ...
    public  void initialize(){
        ...
        req.put("ipnumIpname","");
        res = HttpRequestUtil.request("/api/DailyActivities/getInnovativePracticeList",req);
        ...
        setTableViewData();
        ipkindsList = HttpRequestUtil.getDictionaryOptionItemList("ACT");
    ...
    protected void changeInnovativePracticeInfo() {
        ...
        innovativePracticeId = CommonMethod.getInteger(form,"DailyActivitiesId");
        DataRequest req = new DataRequest();
        req.put("DailyActivitiesId",innovativePracticeId);
        DataResponse res = HttpRequestUtil.request("/api/DailyActivities/getInnovativePracticeInfo",req);
        if(res.getCode()!=0){
    ...
    protected void onQueryButtonClick(){
        ...
        DataResponse res = HttpRequestUtil.request("/api/DailyActivities/getInnovativePracticeList",req);
        if(res != null && res.getCode()== 0) {
            innovativePracticeList = (ArrayList<Map>)res.getData();
            setTableViewData();
        }
    ...
    protected void onDeleteButtonClick() {
        ...
        Integer innovativePracticeId = CommonMethod.getInteger(form,"DailyActivitiesId");
        DataRequest req = new DataRequest();
        req.put("DailyActivitiesId", innovativePracticeId);
        DataResponse res = HttpRequestUtil.request("/api/DailyActivities/innovativePracticeDelete",req);
        if(res.getCode() == 0) {
    ...
    protected void onSaveButtonClick() {
        ...
        req.put("DailyActivitiesId", innovativePracticeId);
        req.put("form", form);
        DataResponse res = HttpRequestUtil.request("/api/DailyActivities/innovativePracticeEditSave",req);
        if(res.getCode() == 0) {
